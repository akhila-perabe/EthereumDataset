...
4. Prices of the previous 3 days
5. Market cap and volume of the day
...
lmHeight = lm(finalTable$price_return~
                finalTable$PrevDayPrice+
                finalTable$Prev2DayPrice+
                finalTable$Prev3DayPrice+
                (finalTable$Frequency * finalTable$TransMean)+
                (finalTable$Market.Cap * finalTable$Volume)+
                log(finalTable$Volume)+
                log(finalTable$Market.Cap)+
...
As you see in the above results, features of the previous day are not able to predict the price return for the current day. This could be because the price return is dependent on other variables not available in this dataset.
